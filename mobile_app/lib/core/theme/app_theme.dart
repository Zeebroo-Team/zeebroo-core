...
class AppColors {
  ...
  // Frosted-glass surfaces (iOS-style translucency for the top bar, bottom
  // bar and side menu) — a near-white tint over whatever content scrolls
  // behind the BackdropFilter blur.
  static const glassSurface = Color(0xF2FFFFFF);
  static const glassHairline = Color(0x14000000);
