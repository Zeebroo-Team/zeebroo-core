{{--
    Print-only letterhead HEADER zone for HR print views.
    Requires: $accentColor, $business, $mainBranch
    Hidden on screen, shown only in @media print.
--}}
<div id="lhHeaderZone" class="lh-print-zone lh-print-zone--header">
