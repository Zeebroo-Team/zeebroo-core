    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        return response()->json([
            'data' => array_merge($card, [
                ...
                'size'               => $product->size,
                'mfg_date'           => $product->mfg_date?->toDateString(),
                'exp_date'           => $product->exp_date?->toDateString(),
